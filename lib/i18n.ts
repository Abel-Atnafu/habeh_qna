...
const TRANSLATIONS = {
  en: {
    ...
    story_badge: 'Crafted in-house',
    story_title_1: 'Every cup,',
    story_title_2: 'a small ceremony.',
    story_body: 'From the first roast to the final pour, our baristas treat espresso the way our grandmothers treated the jebena — slowly, attentively, and always for someone they love.',
    ...
    checkout_pay: 'Submit order',
    checkout_back: 'Back to cart',
    checkout_securely: 'Transfer to one of the accounts below and upload your confirmation screenshot.',
  ...
  am: {
    ...
    story_badge: 'በቤት ውስጥ የሚዘጋጅ',
    story_title_1: 'እያንዳንዱ ስኒ፣',
    story_title_2: 'ትንሽ ስርዓት ነው።',
    story_body: 'ከመጀመሪያው ቆሎ እስከ መጨረሻው ፍሰት ድረስ ባሪስታዎቻችን እስፕሬሶን አያያዝ ቅድመ-አያቶቻችን ጀበናን እንደያዙት — በቀስታ፣ በትኩረት፣ እና ሁልጊዜ ለሚወዱት ሰው ነው።',
    ...
    checkout_pay: 'ትዕዛዝ ያስገቡ',
    checkout_back: 'ወደ ጋሪ ተመለስ',
    checkout_securely: 'ከታች ካሉት መለያዎች ወደ አንዱ ይክፈሉና የክፍያ ማረጋገጫ ስክሪንሾትዎን ይስቀሉ።',
